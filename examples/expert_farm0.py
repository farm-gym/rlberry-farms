...
class ExpertAgent(AgentWithSimplePolicy):
    ...
    def policy(self, observation):
        ...
        # stage for plants (observation[7]) : [0:'none', 1:'seed', 2:'entered_grow', 3:'grow', 4:'entered_bloom', 5:'bloom', 6:'entered_fruit', 7:'fruit', 8:'entered_ripe', 9:'ripe', 10:'entered_seed', 11:'harvested', 12:'dead']

        # observation_txt = self.env.observations_txt
        # my_dict_obs = dict(zip(observation_txt,observation))
                
        if(observation[7] in [8,9]):
            next_action = 6 #harvestiong
        else:
